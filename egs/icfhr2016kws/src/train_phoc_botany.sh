...
TRAIN_TXT=data/lang/Botany/words/char/tr+va_ci.3.txt;
QUERIES_TXT=data/lang/Botany/words/word/te_queries.txt;
WORDS_TXT=data/lang/Botany/words/word/te_words.txt;
OUTPUT_DIR="$1";
shift 1;
...
python3 ./src/python/train_phocnet.py \
       --max_epochs=160 \
