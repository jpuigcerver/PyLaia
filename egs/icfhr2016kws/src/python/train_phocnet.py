...
class Evaluate(object):
    def __init__(self, model, queries_loader, words_loader, gpu):
        self.model = model
...
if __name__ == '__main__':
    ...
    qr_ds, qr_ds_loader = create_dataset_and_loader(
        args.img_dir, args.qry_txt_table, laia.utils.ImageToTensor())
    wd_ds, wd_ds_loader = create_dataset_and_loader(
        args.img_dir, args.doc_txt_table, laia.utils.ImageToTensor())
