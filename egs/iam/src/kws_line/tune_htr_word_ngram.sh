...
for n in 1 2 3 4 5; do
  ...
  check_all_files -s "data/kws_line/lm/word_${n}gram_50k/chars.txt" \
                     "data/kws_line/lm/word_${n}gram_50k/model" || exit 1;

  logfile="$1/tune_acoustic_prior_scale_htr_word_${n}gram_50k.log";
  [ -s "$logfile" ] ||
  ( ./src/kws_line/tune_metric_htr.py \
    "data/kws_line/lm/word_${n}gram_50k/chars.txt" \
    "data/kws_line/lm/word_${n}gram_50k/model" \
