...
mkdir -p data/images/lines data/lang/lines/word;
mkdir -p data/images/words/{te,va};

# Download TRAIN data
[ -s data/lang/lines/word/tr.txt -a \
  -s data/images/lines/002_080_001_01_01.png -a \
  -s data/images/lines/116_649_001_03_24.png ] || {
  ...
  xargs -n1 -I{} mv {} data/images/lines;
  ...
  xargs awk '{
    ...
    print bn, $0;
  }' | sort -V > data/lang/lines/word/tr.txt;
  rm -r data/Train_Lines_Transcriptions* data/Train_Lines_Images*;
}

# Download VALID and TEST data
