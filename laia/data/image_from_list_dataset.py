...
class ImageFromListDataset(ImageDataset):
    def __init__(self, img_list, img_dirs=None, img_transform=None, img_extensions=IMAGE_EXTENSIONS):
        self._ids, imgs = _get_ids_and_images_from_img_list(img_list, img_dirs, img_extensions)
